...
export class Card {
    ...
    resumido() {
      return `  <li class="list-group-item " >  <a href="#" class="lista"> ${this.carro.modelo} </a>
    ...
    pegaCard() {
        ...
        <div class="card col-8" id="cardCarro" data-id= "${this.carro.id}">
                        ...
                        <ul class="list-group list-group-flush">
                          ...
                          <li class="list-group-item">Diária: R$50,00</li>
                        </ul>
                        <div class="card-body">
